...
const ReportRow = (props: ReportRowProps) => {
  ...
  const downloadReport = async (reportName: string) => {
    ...
    if (!session?.accessToken) {
      console.error(
        "Did not attempt to download report. Access token:",
        session?.accessToken,
      );
      return;
    }
    ...
    return (
        ...
        >
            ...
            <TableCell>
                ...
                >
                    ...
                    <Typography
                        ...
                        variant="body2"
                    >
                        {report.reportStartTime && format(new Date(report.reportStartTime), 'MMM dd, h:mm:ss a')} - {report.reportStopTime && format(new Date(report.reportStopTime), 'MMM dd, h:mm:ss a')}
                    </Typography>
                </Box>
            </TableCell>
            <TableCell>
            ...
            <TableCell align="right">
                <Button endIcon={<ArrowDownward fontSize="small"/>} onClick={() => {downloadReport(report.reportName)}}>
                    Download
                </Button>
            </TableCell>
        </TableRow>
