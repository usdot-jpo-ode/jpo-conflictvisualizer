...
const signalStateLayer: LayerProps = {
  id: "signalStates",
  type: "symbol",
  layout: {
    "icon-image": [
...
const initialState = {
  mapMessageLayerStyle: mapMessageLayer,
  mapMessageLabelsLayerStyle: mapMessageLabelsLayer,
  connectingLanesLayerStyle: connectingLanesLayer,
  connectingLanesLabelsLayerStyle: connectingLanesLabelsLayer,
  markerLayerStyle: markerLayer,
  bsmLayerStyle: bsmLayerStyle,
  signalStateLayerStyle: signalStateLayer,
...
export const selectMapMessageLayerStyle = (state: RootState) => state.mapLayerStyle.value.mapMessageLayerStyle;
export const selectMapMessageLabelsLayerStyle = (state: RootState) =>
  state.mapLayerStyle.value.mapMessageLabelsLayerStyle;
export const selectConnectingLanesLayerStyle = (state: RootState) =>
  state.mapLayerStyle.value.connectingLanesLayerStyle;
export const selectConnectingLanesLabelsLayerStyle = (state: RootState) =>
  state.mapLayerStyle.value.connectingLanesLabelsLayerStyle;
export const selectMarkerLayerStyle = (state: RootState) => state.mapLayerStyle.value.markerLayerStyle;
export const selectBsmLayerStyle = (state: RootState) => state.mapLayerStyle.value.bsmLayerStyle;
export const selectSignalStateLayerStyle = (state: RootState) => state.mapLayerStyle.value.signalStateLayerStyle;
export const selectMapLegendColors = (state: RootState) => state.mapLayerStyle.value.mapLegendColors;

export const { setBsmLegendColors, setBsmCircleColor, setSignalLayerLayout } = mapLayerStyleSlice.actions;

export default mapLayerStyleSlice.reducer;
